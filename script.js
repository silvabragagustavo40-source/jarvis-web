// ============================================================
// J.A.R.V.I.S. V4
// Versão conectada à API /api/chat
// ============================================================
...
async function askAI(text) {
  ...
  try {
    ...
    jarvisReply(
      "Não consegui estabelecer comunicação com a inteligência artificial. Verifique a API e a conexão."
    );
...
async function handleImage() {
  ...
  jarvisReply(
    "Imagem recebida. A análise de imagens será habilitada na próxima etapa."
  );
}
